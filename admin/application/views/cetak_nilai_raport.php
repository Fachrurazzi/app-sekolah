...
<table class="table table-sm">
    ...
    <?php foreach($cetak_nilai_raport as $nilai) : ?>
        ...
        <tr>
            ...
            <td><?=ceil($nilai->nilai_senibudaya);?></td>
        </tr>
    <?php endforeach; ?>
    </tbody>
</table>
...
<div class="row">
  <div class="col-md-12">
    <div class="float-right">
        ...
        <p class="text-center">Wali Kelas</p><br><br><br>
        <?php $i = 0; foreach($cetak_nilai_raport as $wali) : ?>
            <?php if($i == 0) : ?>
                <p class="mb-1"><u><b><?=$wali->wali_kelas?></b></u></p>
                <p><b>NIP : <?=$wali->nip;?></b></p>
                <?php $i++; ?>
            <?php endif; ?>
        <?php endforeach; ?>
    </div>
